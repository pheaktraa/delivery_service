                ...
                <div class="divide-y divide-(--gray-300)">
                    ...
                    <div v-for="item in recentHistory" :key="item.id"
                        ...
                        <div class="text-right">
                            ...
                            <span
                                :class="['px-3 py-1 rounded-full text-xs font-bold uppercase', getStatusColor(item.status)]">
                                {{ item.status }}
                            </span>
                        </div>
...
// 1. Stats Data (Keep this)
const stats = reactive({
    earnings: 75,
    delivered: 75
})
// 2. Recent History Data (Mock)
...
// 3. Function to get status color classes
