<template>
  <div class="max-w-7xl mx-auto h-screen bg-(--gray-100) flex justify-center items-center">
    <div class="w-full px-8">
      <!-- HEADER -->
      <div class="mb-[2rem]">
        <h1 class="text-[2rem] font-bold text-(--gray-800)">My Profile</h1>
      </div>
      ...
      <div class="bg-white rounded-2xl sd">
        <div class="p-8 pb-8">
          ...
          <div class="flex justify-between items-end">
            ...
            >
              <img src="../../assets/img/imgprofile.avif" alt="" class="">
            </div>
            <!-- Edit Button -->
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-[1rem]">
            ...
            <div>
              <label
                class="block text-xs font-bold text-(--gray-400) uppercase mb-[1rem]"
                >First Name</label
              >
              <div
                class="w-full p-3 border border-(--gray-300) rounded-lg bg-white font-bold text-(--gray-800)"
              >
                {{ getdata?.firstname || "N/A" }}
              </div>
            </div>
