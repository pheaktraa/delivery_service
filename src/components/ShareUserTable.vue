<template>
  <div class="w-full h-full overflow-x-auto mt-[2rem] border border-(--gray-300) rounded-lg overflow-hidden">
    ...
    <table class="w-full border-collapse text-fixed">
      ...
      <tbody class="divide-y divide-(--gray-200) bg-white">
        <tr v-for="user in users" :key="user.id" class="hover:bg-(--gray-100) transition duration-300">
